            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="pricelistNavbar">
                    <ul class="navbar-nav navbar-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Basic Dance Shows</a>
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item active" href="dance-basic.php">Basic Dance Shows</a>
                            </div>
                        </li>
                    </ul>
                </div>
