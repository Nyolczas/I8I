                    ...
                    <ul class="navbar-nav navbar-right">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="Introdution.html">Introducion</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item active" href="#">Dance Shows</a>
                                <a class="dropdown-item" href="#">Video Projection Solutions</a>
                                <a class="dropdown-item" href="#">100% Freelusion</a>
                                <a class="dropdown-item" href="#">Animation Artworks</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item active" href="#">About Dance Shows</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="#">Tailor Made Dance</a>
                                <a class="dropdown-item" href="#">Full Night Shows</a>
                                <a class="dropdown-item" href="#">Co-Working Shows</a>
                                <a class="dropdown-item" href="#">Premium Dance Shows</a>
                                <a class="dropdown-item" href="#">Basic Dance Shows</a>
                            </div>
                        </li>
                    </ul>
                </div>
