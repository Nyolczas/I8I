            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="pricelistNavbar">
                    <ul class="navbar-nav navbar-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Co-Working Shows</a>
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item active" href="dance-coworking.php">Co-Working Shows</a>
